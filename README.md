...
| [`NOF.Contract.Extension.Authentication`](https://www.nuget.org/packages/NOF.Contract.Extension.Authentication)             | JWT contract extension - authority service contracts and token models                                                   |
| [`NOF.Hosting.Extension.Authentication`](https://www.nuget.org/packages/NOF.Hosting.Extension.Authentication)               | JWT outbound propagation - writes bearer tokens to outbound NOF requests                                                |
