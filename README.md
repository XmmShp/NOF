...
- Message metadata is registered through source-generated handler registries, and inbound dispatch resolves a generated per-handler invoker instead of relying on a process-wide static type resolver.
