...
namespace NOF.Sample.Application.CommandHandlers;

public class GetConfiguration : ICommandHandler<GetConfigurationCommand, GetConfigurationResponse>
{
    ...
    public async Task<Result<GetConfigurationResponse>> HandleAsync(GetConfigurationCommand command, CancellationToken cancellationToken)
    {
        var appNameStr = command.AppName;
