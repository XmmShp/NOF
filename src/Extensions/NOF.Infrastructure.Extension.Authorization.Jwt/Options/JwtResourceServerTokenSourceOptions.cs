...
/// <summary>
/// Configuration for one JWT token source header accepted by the resource server.
/// </summary>
public class JwtResourceServerTokenSourceOptions
{
    private string _headerName = NOFAbstractionConstants.Transport.Headers.Authorization;
    private string _tokenType = "Bearer";
    private JwtDownstreamPropagation? _downstreamPropagation = new()
    {
    ...
    /// </summary>
    public JwtDownstreamPropagation? DownstreamPropagation
    {
