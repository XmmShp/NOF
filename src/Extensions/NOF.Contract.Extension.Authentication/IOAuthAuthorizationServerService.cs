...
public interface IOAuthAuthorizationServerService : IRpcService
{
    ...
    OAuthServerRootDocument GetRoot(Empty request);
    ...
    OAuthServerMetadata GetOpenIdConfiguration(Empty request);
    ...
    OAuthServerMetadata GetAuthorizationServerMetadata(Empty request);
    ...
    JwksDocument GetJwks(Empty request);
    ...
    OAuthTokenEndpointResponse Token(OAuthTokenRequest request);
    ...
    IReadOnlyDictionary<string, object> UserInfo(OAuthUserInfoRequest request);
}
