...
#pragma warning restore RSEXPERIMENTAL002
    ...
    private static string BuildEndpointKey(EndpointInfo endpoint)
        => $"{endpoint.ServiceType.ToDisplayString()}:{endpoint.ServiceMethodName}:{endpoint.Method}:{endpoint.Route}:{endpoint.RequestType.ToDisplayString()}:{endpoint.OperationName}";
