...
Extends `NOF.Infrastructure` with SQLite-specific database provider configuration via Microsoft.Data.Sqlite. These components are now built into the main infrastructure package.
