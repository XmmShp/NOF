...
public class HandlerRegistrationGenerator : IIncrementalGenerator
{
        ...
        string messageTypeExpression)
    {
        ...
        var sb = new StringBuilder();
        sb.AppendLine("    /// <summary>Invokes the generated inbound handler.</summary>");
        sb.AppendLine($"    public sealed class {invokerTypeName} : global::NOF.Application.ICommandInboundHandlerInvoker");
        sb.AppendLine("    {");
        sb.AppendLine("        /// <inheritdoc />");
        ...
        string messageTypeExpression)
    {
        ...
        var sb = new StringBuilder();
        sb.AppendLine("    /// <summary>Invokes the generated inbound handler.</summary>");
        sb.AppendLine($"    public sealed class {invokerTypeName} : global::NOF.Application.INotificationInboundHandlerInvoker");
        sb.AppendLine("    {");
        sb.AppendLine("        /// <inheritdoc />");
        sb.AppendLine($"        public string HandlerTypeName => \"{handlerTypeName}\";");
        sb.AppendLine("        /// <inheritdoc />");
