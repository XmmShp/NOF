...
public class MappableGenerator : IIncrementalGenerator
{
        ...
        HashSet<(string, string)> allAutoGeneratedPairs, SourceProductionContext spc, Location location)
    {
        ...
        if (sourceType.TypeKind == TypeKind.Enum && destType.TypeKind == TypeKind.Enum)
        {
            ...
            registrations.Add(
                $"global::NOF.Abstraction.Registry.MapperRegistrations.Add(global::NOF.Application.MapperRegistration.Of<{srcFull}, {dstFull}>(src => {expr}));");
            return;
        }
        ...
        var header = needsMapper
            ? $"global::NOF.Abstraction.Registry.MapperRegistrations.Add(global::NOF.Application.MapperRegistration.Of<{srcFull}, {dstFull}>((src, mapper) =>"
            : $"global::NOF.Abstraction.Registry.MapperRegistrations.Add(global::NOF.Application.MapperRegistration.Of<{srcFull}, {dstFull}>(src =>";
