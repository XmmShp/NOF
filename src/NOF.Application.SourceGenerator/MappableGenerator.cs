...
public class MappableGenerator : IIncrementalGenerator
{
        ...
        HashSet<(string, string)> allAutoGeneratedPairs, SourceProductionContext spc, Location location)
    {
        ...
        if (sourceType.TypeKind == TypeKind.Enum && destType.TypeKind == TypeKind.Enum)
        {
            ...
            registrations.Add(
                $"registry.MapperRegistry.Add(global::NOF.Application.MapperRegistration.Of<{srcFull}, {dstFull}>(src => {expr}));");
            return;
        }
        ...
        var header = needsMapper
            ? $"registry.MapperRegistry.Add(global::NOF.Application.MapperRegistration.Of<{srcFull}, {dstFull}>((src, mapper) =>"
            : $"registry.MapperRegistry.Add(global::NOF.Application.MapperRegistration.Of<{srcFull}, {dstFull}>(src =>";
