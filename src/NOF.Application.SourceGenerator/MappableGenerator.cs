...
public class MappableGenerator : IIncrementalGenerator
{
        ...
        HashSet<(string, string)> allAutoGeneratedPairs, SourceProductionContext spc, Location location)
    {
        ...
        if (sourceType.TypeKind == TypeKind.Enum && destType.TypeKind == TypeKind.Enum)
        {
            ...
            registrations.Add(
                $"registry.MapperRegistrations.Add(global::NOF.Application.MapperRegistration.Of<{srcFull}, {dstFull}>(src => {expr}));");
            return;
        }
        ...
        var header = needsMapper
            ? $"registry.MapperRegistrations.Add(global::NOF.Application.MapperRegistration.Of<{srcFull}, {dstFull}>((src, mapper) =>"
            : $"registry.MapperRegistrations.Add(global::NOF.Application.MapperRegistration.Of<{srcFull}, {dstFull}>(src =>";
