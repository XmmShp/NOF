...
public sealed class ServiceImplementationGenerator : IIncrementalGenerator
{
    ...
    private static void GenerateForClass(SourceProductionContext context, INamedTypeSymbol classSymbol, Compilation compilation)
    {
        ...
        foreach (var method in serviceMethods)
        {
            ...
            sb.AppendLine("        var inboundPipeline = _serviceProvider.GetRequiredService<global::NOF.Infrastructure.IInboundPipelineExecutor>();");
            sb.AppendLine("        var executionContext = _serviceProvider.GetRequiredService<global::NOF.Contract.IExecutionContext>();");
            sb.AppendLine();
            ...
            sb.AppendLine($"        return ExecuteWithPipelinesAsync(operation, request, outboundContext, outboundPipeline, inboundPipeline, {cancellationTokenArg});");
            sb.AppendLine("    }");
            sb.AppendLine();
            sb.AppendLine($"    private static async {returnType} ExecuteWithPipelinesAsync(");
            sb.AppendLine($"        {nestedInterfaceFqn} operation,");
            sb.AppendLine($"        {requestType} request,");
            sb.AppendLine($"        global::NOF.Contract.OutboundContext outboundContext,");
            sb.AppendLine($"        global::NOF.Contract.IOutboundPipelineExecutor outboundPipeline,");
            sb.AppendLine($"        global::NOF.Infrastructure.IInboundPipelineExecutor inboundPipeline,");
            ...
            sb.AppendLine("            {");
            sb.AppendLine("                Message = request,");
            sb.AppendLine($"                HandlerType = typeof({nestedInterfaceFqn}),");
            ...
            sb.AppendLine("                inboundContext.Response = result;");
