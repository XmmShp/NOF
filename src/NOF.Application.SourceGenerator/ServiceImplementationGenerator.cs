...
public sealed class ServiceImplementationGenerator : IIncrementalGenerator
{
    ...
    private static void GenerateForClass(SourceProductionContext context, INamedTypeSymbol classSymbol, Compilation compilation)
    {
        ...
        foreach (var method in serviceMethods)
        {
            ...
            sb.AppendLine("            ExecutionContext = executionContext,");
            ...
            sb.AppendLine($"            var operation = sp.GetRequiredService<{nestedInterfaceFqn}>();");
            sb.AppendLine("            var inboundExecutionContext = sp.GetRequiredService<global::NOF.Contract.IExecutionContext>();");
            sb.AppendLine();
            sb.AppendLine("            foreach (var key in outboundContext.ExecutionContext.Keys)");
            sb.AppendLine("            {");
            sb.AppendLine("                inboundExecutionContext[key] = outboundContext.ExecutionContext[key];");
            sb.AppendLine("            }");
            sb.AppendLine();
            ...
            sb.AppendLine("                ExecutionContext = inboundExecutionContext,");
