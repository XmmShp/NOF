...
public class ValueObjectGenerator : IIncrementalGenerator
{
    ...
    private static string GenerateSource(ValueObjectInfo info)
    {
        ...
        sb.AppendLine("        {");
        sb.AppendLine($"            private static global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<{info.PrimitiveFullName}> __GetPrimitiveJsonTypeInfo(global::System.Text.Json.JsonSerializerOptions options)");
        sb.AppendLine("            {");
        sb.AppendLine("                try");
        sb.AppendLine("                {");
        sb.AppendLine($"                    if (options.GetTypeInfo(typeof({info.PrimitiveFullName})) is global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<{info.PrimitiveFullName}> typeInfo)");
        sb.AppendLine("                    {");
        sb.AppendLine("                        return typeInfo;");
        sb.AppendLine("                    }");
        sb.AppendLine("                }");
        sb.AppendLine("                catch (global::System.NotSupportedException ex)");
        sb.AppendLine("                {");
        sb.AppendLine($"                    throw new global::System.InvalidOperationException(\"JSON metadata for primitive type '{info.PrimitiveFullName}' required by value object '{info.TypeName}' was not found. Add a JsonSerializerContext or resolver for this primitive type to the JsonSerializerOptions used by this operation.\", ex);");
        sb.AppendLine("                }");
        sb.AppendLine();
        sb.AppendLine($"                throw new global::System.InvalidOperationException(\"JSON metadata for primitive type '{info.PrimitiveFullName}' required by value object '{info.TypeName}' was not found. Add a JsonSerializerContext or resolver for this primitive type to the JsonSerializerOptions used by this operation.\");");
        sb.AppendLine("            }");
        sb.AppendLine();
        ...
        sb.AppendLine("            {");
        sb.AppendLine("                var primitive = global::System.Text.Json.JsonSerializer.Deserialize(ref reader, __GetPrimitiveJsonTypeInfo(options))!;");
