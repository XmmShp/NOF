...
public class ValueObjectGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        {
            var validInfos = new System.Collections.Generic.List<ValueObjectInfo>();
            ...
            {
                var configSource = GenerateConfigureMethod(validInfos);
                spc.AddSource("ValueObjectJsonSerializerOptionsExtensions.g.cs",
                    SourceText.From(configSource, Encoding.UTF8));
            }
        });
    }
    ...
    private static string GenerateConfigureMethod(System.Collections.Generic.List<ValueObjectInfo> infos)
    {
        var sb = new StringBuilder();
        sb.AppendLine("// <auto-generated/>");
        sb.AppendLine("#nullable enable");
        sb.AppendLine();
        sb.AppendLine("namespace NOF.Domain");
        sb.AppendLine("{");
        sb.AppendLine("    /// <summary>");
        sb.AppendLine("    /// Extension methods for configuring value object JSON converters.");
        sb.AppendLine("    /// </summary>");
        sb.AppendLine("    public static class ValueObjectJsonSerializerOptionsExtensions");
        sb.AppendLine("    {");
        sb.AppendLine("        /// <summary>");
        sb.AppendLine("        /// Registers all source-generated value object JSON converters into the specified options.");
        sb.AppendLine("        /// </summary>");
        sb.AppendLine("        public static global::System.Text.Json.JsonSerializerOptions ConfigureValueObjectJsonSerializerOptions(this global::System.Text.Json.JsonSerializerOptions options)");
        sb.AppendLine("        {");

        foreach (var info in infos)
        {
            sb.AppendLine($"            options.Converters.Add(new global::{info.Namespace}.{info.TypeName}.__JsonConverter());");
        }
