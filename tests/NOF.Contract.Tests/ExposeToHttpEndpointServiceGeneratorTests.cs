...
public class ExposeToHttpEndpointServiceGeneratorTests
{
    ...
    public void GeneratesCustomOperationName()
    {
        const string source = """
                              ...
                              namespace MyApp
                              {
                                  [PublicApi(OperationName = "GetProfile")]
                                  [HttpEndpoint(HttpVerb.Get, "/users/profile")]
                                  public partial class UserProfileRequest : IRequest<string> { }
    ...
    public void DoesNotGenerateWhenNoPublicApiRequests()
    {
        const string source = """
                              ...
                              namespace MyApp
                              {
                                  // No [PublicApi] — should be ignored
                                  [HttpEndpoint(HttpVerb.Post)]
                                  public class PlainRequest : IRequest { }
