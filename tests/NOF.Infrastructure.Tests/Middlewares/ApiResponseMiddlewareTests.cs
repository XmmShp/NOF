...
public class ApiResponseMiddlewareTests
{
    ...
    {
        // Arrange
        var mockLogger = new Mock<ILogger<ApiResponseMiddleware>>();
        var middleware = new ApiResponseMiddleware(mockLogger.Object);
    ...
    public void IsOpenApiRequest_SwaggerPath_ShouldReturnTrue()
    {
        ...
        // Act
        var result = ApiResponseMiddleware.IsOpenApiRequest(context.Request);
    ...
    public void IsOptionsRequest_OptionsMethod_ShouldReturnTrue()
    {
        ...
        // Act
        var result = ApiResponseMiddleware.IsOptionsRequest(context.Request);
    ...
    public void IsSignalRRequest_HubsPath_ShouldReturnTrue()
    {
        ...
        // Act
        var result = ApiResponseMiddleware.IsSignalRRequest(context.Request);
    ...
    public void IsApiContentType_JsonContentType_ShouldReturnTrue()
    {
        ...
        // Act
        var result = ApiResponseMiddleware.IsApiContentType(context.Response);
